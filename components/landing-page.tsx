    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center fixed w-full bg-white z-10">
        <a className="flex items-center justify-center" href="#hero">
          ...
          <span className="font-bold text-lg">4GeneAI</span>
        </a>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold mb-2">Rapid Analysis</h3>
                <p className="text-gray-600">Process genetic data at unprecedented speeds with our AI-powered algorithms.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Brain className="h-12 w-12 mb-4 text-purple-600" />
                <h3 className="text-xl font-bold mb-2">Intelligent Insights</h3>
                <p className="text-gray-600">Gain deep insights into genetic patterns and potential health implications.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Lock className="h-12 w-12 mb-4 text-purple-600" />
                <h3 className="text-xl font-bold mb-2">Secure & Private</h3>
                <p className="text-gray-600">Your genetic data is protected with state-of-the-art security measures.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="flex items-center justify-center space-x-2 text-purple-600">
                ...
                <a href="mailto:sales@4geneai.com" className="text-lg font-medium hover:underline">
                  sales@4geneai.com
                </a>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-600">© 2023 4GeneAI. All rights reserved.</p>
